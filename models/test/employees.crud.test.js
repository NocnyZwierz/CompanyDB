  ...
  describe("Reading data", () => {
    before(async () => {
      const testEmpOne = new Employees({
        firstName: "Thomas",
        lastName: "Jefferson",
        department: "678a665b0b35405383a1491c",
      });
      ...
      const testEmpTwo = new Employees({
        firstName: "Amanda",
        lastName: "Johnson",
        department: "678a665b0b35405383a1491b",
      });
    ...
    it("should return a proper document by various params with findOne method", async () => {
      const employee = await Employees.findOne({ firstName: "Thomas" });
      const expectedOutput = "Thomas";
      expect(employee.firstName).to.be.equal(expectedOutput);
      const employee2 = await Employees.findOne({ lastName: "Jefferson" });
      const expectedOutput2 = "Jefferson";
  ...
  describe("Creating data", () => {
    it('should insert new document with "insertOne" method', async () => {
      const employee = new Employees({
        firstName: "John",
        lastName: "Doe",
        department: "677ae38082799cf3094112ad",
      });
      await employee.save();
  ...
  describe("Updating data", () => {
    ...
    it('should properly update multiple documents with "updateMany" method', async () => {
      await Employees.updateMany(
        {},
        { $set: { department: "677ae38882799cf3094112ae" } }
      );
      const employees = await Employees.find();
